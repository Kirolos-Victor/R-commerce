        ...
        <div class="container-fluid">
            ...
            <!-- end page title -->
                    ...
                    <div class="card">
                        ...
                        @endif
                        <div class="card-body">
                            <a class="btn btn-primary mb-3" href="{{route('cities.create')}}">Create City</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <a class="w-50 col-6 btn btn-primary" href="{{route('cities.edit',$city->id)}}" >Update</a>
                                                <form class="col-6" action="{{route('cities.destroy',$city->id)}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
