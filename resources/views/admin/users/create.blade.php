                                        ...
                                        <div class="col-lg-6">
                                            <div>
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input id="first-name" class="form-control input-mask" type="text" name="first_name" >
                                                </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mt-4 mt-lg-0">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input type="text" name="last_name" id="last-name" class="form-control input-mask" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mt-4 mt-lg-0">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input type="email" name="email" id="email" class="form-control input-mask" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mt-4 mt-lg-0">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input type="text" name="phone" id="phone" class="form-control input-mask" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
