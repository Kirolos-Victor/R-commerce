        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Areas</h4>
            ...
            <!-- end page title -->
                    ...
                    <div class="card">
                        ...
                        @endif
                        <div class="card-body">
                            <a class="btn btn-primary mb-3" href="{{route('areas.create')}}">Create Area</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <a class="w-50 col-6 btn btn-primary" href="{{route('areas.edit',$area->id)}}" >Update</a>
                                                <form class="col-6" action="{{route('areas.destroy',$area->id)}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
