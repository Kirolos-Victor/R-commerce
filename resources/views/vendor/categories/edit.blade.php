                                        ...
                                        <div class="col-lg-6">
                                            <div>
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input id="english-name" class="form-control input-mask" type="text" name="name_en" value="{{$category->name_en}}">
                                                </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mt-4 mt-lg-0">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input type="text" name="name_ar" id="arabic-name" class="form-control input-mask" value="{{$category->name_ar}}" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
