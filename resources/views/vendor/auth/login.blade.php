                    ...
                    <div class="card-body pt-0">
                        ...
                        @if ($errors->any())
                            <div class="alert alert-danger">
                                <ul>
                                    <li>The credentials that you've entered are incorrect</li>
                                </ul>
                            </div>
                        @endif
                        <div class="p-2">
                            <form class="form-horizontal" action="{{route('vendor.login.submit')}}" method="POST">
                                @csrf

                                <div class="mb-3">
                                    <label for="email" class="form-label">E-mail Address</label>
                                    <input type="text" class="form-control" id="email" placeholder="Enter E-mail Address" name="email">
                                </div>
