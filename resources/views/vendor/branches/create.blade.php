                                        ...
                                        <div class="col-lg-6">
                                            <div class="mt-4 mt-lg-0">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input type="text" name="phone_number" id="phone-number" class="form-control input-mask" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mt-4 mt-lg-0">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input type="text" name="contact_person_number" id="contact-person" class="form-control input-mask" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            ...
                                            <div id="map" style="width:100%;height:500px;margin-top: 50px!important;"></div>
