            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Vendor Users</h4>
            ...
            <!-- end page title -->
                    ...
                    <div class="card">
                        ...
                        @endif
                            ...
                            @endif
                        <div class="card-body">
                            <a class="btn btn-primary mb-3" href="{{route('vendor-users.create')}}">Create Vendor User</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <a class="w-30 col-6 btn btn-primary" href="{{route('vendor-users.edit',$user->id)}}" >Update</a>
                                                <form class="col-6" action="{{route('vendor-users.destroy',$user->id)}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                            ...
                            <div class="d-flex justify-content-between align-items-center flex-wrap" style="position: relative;top: 0;bottom: 0;left: 0; right: 0; width: 200px; height: 100px; margin: auto;">
                                <div class="d-flex flex-wrap mr-3">
                                    ...
                                    {{$vendorUsers->links('vendor.pagination.custom')}}
